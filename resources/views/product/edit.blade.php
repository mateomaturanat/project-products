        ...
        <section>
            <form action="/products/{{$product->slug}}" class="row" method="POST">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="number" class="form-control" id="priority" name="priority" value="{{old('priority', $product->priority)}}">
                </div>
                <div class="mb-3 col-6">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="text" class="form-control" id="value" name="value" value="{{old('value',$product->value)}}">
                </div>
